import { z } from "zod";
import { jobTypes, locationType } from "./JobsTypes";
...
const companyLogoSchema = z
  ...
  .refine((file) => 
 !file || (file instanceof File && file.type.startsWith("image/")), "Must be image file")
  .refine((file) => {
...
const locationSchema = z.object({
  locationType: requiredString.refine(
    value => locationType.includes(value), "Invalid Location"
  ),
